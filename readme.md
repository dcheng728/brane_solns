...
This repo exists to explore that possibility. Alongside the scientific goals of this project, I want to investigate how AI can facilitate theoretical physics research — both the creative aspects of the work and the more menial tasks that AI could take off a physicist's hands.
...
```
IIB_in_12d/
├── src/              # source code for computations
├── agents/           # defining agents for different tasks
├── writeups/         # tex files
└── README.md
```
