...
\begin{equation}
\mathcal A_{D(-1)}\sim (\alpha')^4t_8t_8R^4\sum_{m,n\ge1}\left(\frac{m}{n^3}\right)^{1/2}
...
% In particular, we will look into functions that admit expansions over Eisenstein series $E_{3/2}(\tau,\bar\tau)$.
% We may also consider possible 12d interpretations of the critical IIB 5-point amplitudes.
% In this project, we will also seek to understand such U(1)-obstruction.
