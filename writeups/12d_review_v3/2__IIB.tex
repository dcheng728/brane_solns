...
The coset representative of $\frac{SL(2, R)}{U(1)}$ is an SL(2, R) matrix $\mathcal{V}$ with a local U(1) symmetry. It is convenient to factor out the $U(1)\cong SO(2)$ using the Iwasawa decomposition \cite{iwasawa1949}
\begin{equation}
\mathcal{V} = 
\begin{pmatrix}
1 & 0 \\
