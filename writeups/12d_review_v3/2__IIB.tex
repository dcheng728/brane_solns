...
{\color{orange}
We have been discussing the type IIB supergravity multiplet, which captures the massless spectrum of the quadratic (free) theory with SO(9, 1) symmetry, and an SO(2) $\cong$ U(1) rigid internal symmetry acting on the supercharges.
The nonlinear (interacting) theory is obtained as by restoring an infinite number of terms of various order in $\kappa$, and promoting the rigid symmetries to be local. Doing so \cite{Green:1982tk,Schwarz:1983wa,Schwarz:1983qr,Howe:1983sra} one finds that the theory has a larger hidden global symmetry group SL(2, R), which when combined with the now localised U(1) symmetry, gives $\frac{SL(2, R)}{U(1)}$ as scalar manifold.
