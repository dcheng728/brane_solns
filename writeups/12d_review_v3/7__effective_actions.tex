...
\begin{equation}
\mathcal A_4
=\frac{1}{3\cdot 2^3}t_8^{m_1...m_8}t_8^{n_1...n_8}               
...
\prod_{r=1}^4\zeta^{(r)}_{m_{2r}n_{2r}}k^{(r)}_{m_{2r-1}}k^{(r)}_{n_{2r-1}}
&=t_8^{m_1...m_8}t_8^{n_1...n_8}
\prod_{r=1}^4 \kappa h^{(r)}_{m_{2r}n_{2r},m_{2r-1} n_{2r-1}}.\\
&= \frac{t_8t_8 R^4}{16} + O(h^4).
\end{aligned}
\end{equation}
\footnote{
...
\begin{equation}
\mathcal L_4 =
\frac{1}{2\kappa^2}\frac{(\alpha')^3}{3\cdot 2^7}t_8t_8 R^4\frac{4^3}{\alpha^{\prime 3}stu}
