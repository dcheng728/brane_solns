...
{\color{orange}
Among the known BPS branes in the type IIA, IIB, and 11d theories \cite{Stelle:1998xg}, the D7 brane plays a special role: it is co-dimension 2, which means its harmonic function is logarithmic rather than exhibiting the power-law behavior $\sim \frac{1}{r^{\tilde{d}-2}}$, and thus is not asymptotically flat.
