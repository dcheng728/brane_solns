...
=\text{Vol}(D7) 
\underbrace{\int_{\tau(\mathbb{C})}d\tau d\bar\tau\left[-\frac{i}{2}\frac{1}{\tau_2^2}\right]}_{\mathcal{E}},
...
\end{equation}
Performing a holomorphic coordinate transformation $dw(z) = \eta^2(\tau)\prod_i (z-z_i)^{-1/12} dz$, we obtain
\begin{equation}
