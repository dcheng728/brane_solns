...
\end{equation}
In 12d perspective, $DP$ contains second order derivatives on $\tau$, which are components of the metric, hence may be obtained from linear combinations of 12d Riemann tensor components.
